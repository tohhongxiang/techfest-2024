      ...
      <form onSubmit={handleSubmit}>
        <Stack>
          ...
          <Alert variant="light" color="blue">
            LTTT is a Generative AI tool that generates summary shorts of
            lecture inputs. It can also learn from the lecture content and
            provide clarifications to content.
          </Alert>
                ...
                <ReactPlayer
                  ...
                  url={
                    form.values.uploadedFile
                      ? URL.createObjectURL(form.values.uploadedFile!)
